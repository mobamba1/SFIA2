...
def home():
  ...
  data = requests.get('http://34.105.244.35:5004/service4')
...
def update():
  data = requests.get('http://34.105.244.35:5002/service2')
  data1 = requests.get('http://34.105.244.35:5003/service3')
